export const festival = {
  name: "25常盤祭（紅陽）",
  days: [
    { dateLabel: "10/31 (Fri)", time: "13:00 – 20:30" },
    { dateLabel: "11/1 (Sat)", time: "09:00 – 20:30" },
    { dateLabel: "11/2 (Sun)", time: "09:00 – 15:00" },
  ],
  periodText: "2025年10月31日(金) — 11月2日(日)",
  venue: {
    name: "横浜国立大学 常盤台キャンパス",
    address: "〒240-8501 神奈川県横浜市保土ヶ谷区常盤台79-1 付近",
    // 大学公式アクセスページの地図に近い座標（正門付近）
    lat: 35.4739,
    lng: 139.5916,
    gmap: "https://maps.google.com/?q=35.4739,139.5916",
  },
};
